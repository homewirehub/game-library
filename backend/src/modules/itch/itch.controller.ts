...
export class ItchController {
  ...
  async searchGames(@Body() request: SearchGamesRequest): Promise<ItchGame[]> {
    try {
      ...
      throw new HttpException('Failed to search games', HttpStatus.INTERNAL_SERVER_ERROR);
    }
  }
  ...
  async getAllDownloads(): Promise<DownloadProgress[]> {
    try {
      ...
      throw new HttpException('Failed to get download list', HttpStatus.INTERNAL_SERVER_ERROR);
    }
  }
  ...
  async getDownloadProgress(@Param('gameId') gameId: string): Promise<DownloadProgress> {
    try {
      ...
      if (!progress) {
        throw new HttpException(`Download not found for game: ${gameId}`, HttpStatus.NOT_FOUND);
      }
      ...
      throw new HttpException('Failed to get download progress', HttpStatus.INTERNAL_SERVER_ERROR);
    }
  }
  ...
  async cancelDownload(@Param('gameId') gameId: string) {
    try {
      ...
      throw new HttpException('Failed to cancel download', HttpStatus.INTERNAL_SERVER_ERROR);
    }
  }
  ...
  async retryDownload(@Param('gameId') gameId: string) {
    try {
      ...
      throw new HttpException('Failed to retry download', HttpStatus.INTERNAL_SERVER_ERROR);
    }
  }
  ...
  async getLocalGames(): Promise<ItchGame[]> {
    try {
      ...
      throw new HttpException('Failed to get local games list', HttpStatus.INTERNAL_SERVER_ERROR);
    }
  }
  ...
  async cleanupDownloads() {
    try {
      ...
      throw new HttpException('Failed to cleanup downloads', HttpStatus.INTERNAL_SERVER_ERROR);
    }
  }
  ...
  async getFeaturedGames(@Query('limit') limit?: string): Promise<ItchGame[]> {
    try {
      ...
      throw new HttpException('Failed to get featured games', HttpStatus.INTERNAL_SERVER_ERROR);
    }
  }
  ...
  async getGamesByCategory(
    ...
    try {
      ...
      throw new HttpException('Failed to get games by category', HttpStatus.INTERNAL_SERVER_ERROR);
    }
  }
}
